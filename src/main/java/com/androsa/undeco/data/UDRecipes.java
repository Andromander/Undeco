...
public class UDRecipes extends OrnamentalRecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
		...
		wallOverride(consumer, ModBlocks.polished_granite_wall, Blocks.POLISHED_GRANITE);
		wallOverride(consumer, ModBlocks.polished_diorite_wall, Blocks.POLISHED_DIORITE);
		wallOverride(consumer, ModBlocks.polished_andesite_wall, Blocks.POLISHED_ANDESITE);
		wallOverride(consumer, ModBlocks.oak_log_wall, Blocks.OAK_LOG);
		wallOverride(consumer, ModBlocks.spruce_log_wall, Blocks.SPRUCE_LOG);
		wallOverride(consumer, ModBlocks.birch_log_wall, Blocks.BIRCH_LOG);
		wallOverride(consumer, ModBlocks.jungle_log_wall, Blocks.JUNGLE_LOG);
		wallOverride(consumer, ModBlocks.acacia_log_wall, Blocks.ACACIA_LOG);
		wallOverride(consumer, ModBlocks.cherry_log_wall, Blocks.CHERRY_LOG);
		wallOverride(consumer, ModBlocks.dark_oak_log_wall, Blocks.DARK_OAK_LOG);
		wallOverride(consumer, ModBlocks.mangrove_log_wall, Blocks.MANGROVE_LOG);
		wallOverride(consumer, ModBlocks.bamboo_block_wall, Blocks.BAMBOO_BLOCK);
		wallOverride(consumer, ModBlocks.crimson_stem_wall, Blocks.CRIMSON_STEM);
		wallOverride(consumer, ModBlocks.warped_stem_wall, Blocks.WARPED_STEM);
		wallOverride(consumer, ModBlocks.stone_wall, Blocks.STONE);
		wallOverride(consumer, ModBlocks.smooth_stone_wall, Blocks.SMOOTH_STONE);
		wallOverride(consumer, ModBlocks.smooth_sandstone_wall, Blocks.SMOOTH_SANDSTONE);
		wallOverride(consumer, ModBlocks.smooth_red_sandstone_wall, Blocks.SMOOTH_RED_SANDSTONE);
		wallOverride(consumer, ModBlocks.cracked_stone_brick_wall, Blocks.CRACKED_STONE_BRICKS);
		wallOverride(consumer, ModBlocks.prismarine_brick_wall, Blocks.PRISMARINE_BRICKS);
		wallOverride(consumer, ModBlocks.dark_prismarine_wall, Blocks.DARK_PRISMARINE);
		wallOverride(consumer, ModBlocks.purpur_wall, Blocks.PURPUR_BLOCK);
        wallOverride(consumer, ModBlocks.tuff_wall, Blocks.TUFF);
